...
//             connection = DriverManager.getConnection(url,"root_username","root_password");
            ...
            while(rs.next()) {
                ...
                System.out.println("\nD\nate : "+ getDateValue(String.valueOf(rs.getString("Start_Time"))));
                System.out.println("Timings : "+timeformat(val1)+" - "+timeformat(val2));
                System.out.println("Day of week : "+getDayofWeek(String.valueOf(rs.getString("Start_Time")))+"\n");
            }
            ...
            drawBreaker();
            System.out.println("\nHighest Volume of Calls On : ");
            drawBreaker();

            resultHighest.first();

            System.out.println("\n\nDate : "+resultHighest.getString(1));
            System.out.println("Total Reieved : "+resultHighest.getString(2));
            System.out.println("Day of week : "+getDayofWeek(String.valueOf(resultHighest.getString(1)))+"\n");
    ...
    public static void drawBreaker(){
        for(int i =0;i<100;i++){
            System.out.print("-");
        }
    }
